...
export class EmailService {
    ...
    async sendNewUserRegistrationNotification(username: string, email: string) {
        if (!this.isConfigured || !this.transporter) {
    ...
    async sendUserApprovalConfirmation(userEmail: string, username: string) {
        if (!this.isConfigured || !this.transporter) {
    ...
    async sendUserRejectionNotification(userEmail: string, username: string) {
        if (!this.isConfigured || !this.transporter) {
